...
public final class I18N {
    ...
    public static final LangString WINDOW_IMPORT_ERROR = builder()
            .en("Failed to import the archive. The ZIP may be invalid (not generated by this application) or the encryption password may be incorrect.")
            // TOOD: ru
            .build();
